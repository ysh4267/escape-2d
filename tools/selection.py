...
SELECTION = [
    ...
    ('Aseptic bandage',                          'bandage',   'meds', 0.10, 1, {'res': 1}),
    ('Army bandage',                             'armyband',  'meds', 0.15, 1, {'res': 2}),
    ...
    # ---------------- weapons ----------------
    ('Kalashnikov AKS-74U 5.45x39 assault rifle',      'w_aks74u', 'weapon', 2.20, 1, {}),
    ('Kalashnikov AK-74N 5.45x39 assault rifle',       'w_ak74n',  'weapon', 3.30, 1, {}),
    ('Kalashnikov AKM 7.62x39 assault rifle',          'w_akm',    'weapon', 3.40, 1, {}),
    ('Molot Arms VPO-136 Vepr-KM 7.62x39 carbine',     'w_vpo136', 'weapon', 3.20, 1, {}),
    ('PP-91 Kedr 9x18PM submachine gun',               'w_kedr',   'weapon', 1.40, 1, {}),
    ('PP-91-01 Kedr-B 9x18PM submachine gun',          'w_kedrb',  'weapon', 1.55, 1, {}),
    ('MP-153 12ga semi-automatic shotgun',             'w_mp153',  'weapon', 3.60, 1, {}),
    ('MP-133 12ga pump-action shotgun',                'w_mp133',  'weapon', 3.20, 1, {}),
    ('Saiga-12K ver.10 12ga semi-automatic shotgun',   'w_saiga',  'weapon', 3.80, 1, {}),
    ('Makarov PM 9x18PM pistol',                       'w_pm',     'pistol', 0.73, 1, {}),
    ('TT-33 7.62x25 TT pistol',                        'w_tt',     'pistol', 0.85, 1, {}),
    ('PB 9x18PM silenced pistol',                      'w_pb',     'pistol', 0.97, 1, {}),
    ...
    # ---------------- magazines ----------------
    ('AK-74 5.45x39 6L20 30-round magazine',       'mag_ak74', 'mag', 0.21, 1, {}),
    ('AK 7.62x39 6L10 bakelite 30-round magazine', 'mag_akm',  'mag', 0.33, 1, {}),
    ('PM 9x18PM 90-93 8-round magazine',           'mag_pm',   'mag', 0.08, 1, {}),
    ('PP-91 Kedr 9x18PM 20-round magazine',        'mag_kedr', 'mag', 0.11, 1, {}),

    # ---------------- ammo ----------------
    ('5.45x39mm PS gs',    'am_545ps',   'ammo', 0.011, 60, {}),
    ('5.45x39mm BP gs',    'am_545bp',   'ammo', 0.012, 60, {}),
    ('7.62x39mm PS gzh',   'am_762ps',   'ammo', 0.016, 60, {}),
    ('7.62x39mm BP gzh',   'am_762bp',   'ammo', 0.017, 60, {}),
    ('9x19mm Pst gzh',     'am_9x19pst', 'ammo', 0.010, 50, {}),
    ('9x18mm PM PSt gzh',  'am_9x18pst', 'ammo', 0.009, 50, {}),
    ('12/70 7mm buckshot', 'am_12buck',  'ammo', 0.055, 20, {}),
    ('7.62x25mm TT LRN',   'am_762tt',   'ammo', 0.009, 50, {}),
]
